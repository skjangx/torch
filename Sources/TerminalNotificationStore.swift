...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.torch-terminal.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.torch-terminal.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.torch-terminal.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.torch-terminal.app.userNotification"
    static let actionShowIdentifier = "com.torch-terminal.app.userNotification.show"
